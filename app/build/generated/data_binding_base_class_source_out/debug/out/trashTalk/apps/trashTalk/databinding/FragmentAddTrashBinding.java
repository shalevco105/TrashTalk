...
public final class FragmentAddTrashBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText editTrashAddress;
  ...
  @NonNull
  public final TextView trashAddressTextView;
  ...
  private FragmentAddTrashBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button cancelRecipeButton, @NonNull EditText editRecipe,
      @NonNull EditText editTrashAddress, @NonNull EditText editTrashName,
      @NonNull ImageView previewTrashImageView, @NonNull TextView recipeTextView,
      @NonNull Button saveRecipeButton, @NonNull TextView trashAddressTextView,
    ...
    this.editTrashAddress = editTrashAddress;
    ...
    this.trashAddressTextView = trashAddressTextView;
  ...
  @NonNull
  public static FragmentAddTrashBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAddTrashBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_add_trash, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAddTrashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editTrashAddress;
      EditText editTrashAddress = ViewBindings.findChildViewById(rootView, id);
      if (editTrashAddress == null) {
        break missingId;
      }
      ...
      id = R.id.trashAddressTextView;
      TextView trashAddressTextView = ViewBindings.findChildViewById(rootView, id);
      if (trashAddressTextView == null) {
        break missingId;
      }
      ...
      return new FragmentAddTrashBinding((ConstraintLayout) rootView, cancelRecipeButton,
          editRecipe, editTrashAddress, editTrashName, previewTrashImageView, recipeTextView,
          saveRecipeButton, trashAddressTextView, trashNameTextView, uploadImageButton,
          uploadImageTextView);
    }
